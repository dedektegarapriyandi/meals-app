class FavMeals extends HTMLElement {
    constructor() {
        super();
        ...
        const showFav=()=>{
            ...
            if(favMeals.length===0){
                ...
                mealsList.innerHTML='<h1>Makanan Favorit Belum Ada</h1>'
            }else{
                mealsList.innerHTML='';
                console.log(favMeals);
                favMeals.map((mealId)=>{
        ...
        const displayResults=(meal)=>{
            let isFav=true;
            mealsList.innerHTML +=`<div class="meal">
...
window.customElements.define("fav-meals", FavMeals)